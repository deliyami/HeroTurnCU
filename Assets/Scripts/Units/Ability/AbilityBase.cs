...
public class AbilityBase : MonoBehaviour
{
    ...
    public virtual IEnumerator BeforeRunTurn(Field field) { yield return null; }
    ...
    public virtual float OnDefense(Unit defender, float type) { return 1; }
    ...
    // return 0 = 상태이상, 1 = 불완전한 상태이상
    public virtual List<ConditionID> AfterAttack(BattleUnit attacker, BattleUnit defender, Move move) { return null; }
    public virtual void AfterDefense(BattleUnit defender, Move move) { }
